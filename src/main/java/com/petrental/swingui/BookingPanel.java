...
public class BookingPanel extends JPanel {
    ...
    public BookingPanel(JFrame parentFrame, UserService userService) {
        ...
        bookButton.addActionListener(e -> {
            ...
            try {
                ...
                Booking booking = new Booking(pet, room, checkInDate, checkOutDate, totalPrice);
    ...
    private void saveBookings() {
        try {
            ...
            // Write list of bookings to JSON
            objectMapper.writerWithDefaultPrettyPrinter().writeValue(file, bookingList);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
